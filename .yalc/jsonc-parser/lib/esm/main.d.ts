...
export interface JSONVisitor {
    ...
    /**
     * Invoked when a line break is encountered. The offset and length represent the location of the line break.
     */
    onLineBreak?: (lineNumber: number, offset: number, length: number) => void;
    /**
